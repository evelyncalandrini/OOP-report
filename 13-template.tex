...
In questa sezione verranno analizzate le scelte progettuali relative alla modellazione della gerarchia dei giocatori e del controller delle azini del gioco.
...
Linterfaccia grafica inova i metodi pubblici de controller come \texttt{hit()} ,\texttt{stand()} e \texttt{doubleDown()} quando l’utente preme il pulsante.
